CREATE TABLE uw_ColorThing_color(uw_id int8 NOT NULL, uw_nam text NOT NULL,
 ...
 CREATE TABLE uw_ColorThing_t(uw_id int8 NOT NULL, uw_nam text NOT NULL, 
                               uw_color int8 NOT NULL,
  PRIMARY KEY (uw_id),
   CONSTRAINT uw_ColorThing_t_Nam UNIQUE (uw_nam),
                                                  
    CONSTRAINT uw_ColorThing_t_IdGtZero CHECK (uw_id > 0::int8),
                                                                
    CONSTRAINT uw_ColorThing_t_Color
